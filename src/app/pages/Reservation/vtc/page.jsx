...
const VtcService = () => {
    ...
    return (
        ...
        <div className="vtc-service-Outline">
            <form onSubmit={onFormSubmit} className="form">
                <h1 className="vtc-service-Heading">{t('vtc')}</h1>
                <h1 className="vtc-service-title">{t('byPhone')}</h1>
                ...
                <div className="row">
                    ...
                    <div>
                        <label className="label">{t('noOfPassengers')} <span style={{ color: 'red' }}>*</span></label>
